...
let calification = document.querySelector('.calification'); // evalutation div //
let thanks = document.querySelector('.thanks'); // thank you div //
...
for (let i = 0; i < ratings.length; i++) {
          ...
          ratings[i].addEventListener('click', () => {
                    ...
                    btn.addEventListener('click', () => {
                              calification.style.display = 'none';
